...
public class InstrucaoAddi extends TipoI
{
	public InstrucaoAddi(String instrucao, InterfaceMontadorInstrucao montador)
	{
	...
	public void executaEm(UCP ucp) throws Exception 
	{
		...
		rt.setConteudo(ULA.soma(rs.getConteudo(), im));
	}
}