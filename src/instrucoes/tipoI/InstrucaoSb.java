...
public class InstrucaoSb extends TipoI
{
	public InstrucaoSb(String instrucao, InterfaceMontadorInstrucao montador)
	{
	...
	public void executaEm(UCP ucp) throws Exception 
	{
		...
		String bytE = rt.getConteudo().substring(24, 32);
		
		ucp.setByteMemoria(Util.getInteiroComSinal(offset), bytE);
	}
}
