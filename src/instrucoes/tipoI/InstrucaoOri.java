...
public class InstrucaoOri extends TipoI
{
	public InstrucaoOri(String instrucao, InterfaceMontadorInstrucao montador)
	{
	...
	public void executaEm(UCP ucp) throws Exception 
	{
		...
		rt.setConteudo(ULA.or(rs.getConteudo(), im));
	}
}
