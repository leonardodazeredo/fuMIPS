...
public class InstrucaoNor extends TipoR
{
	public InstrucaoNor(String instrucao, InterfaceMontadorInstrucao montador)
	{
	...
	protected void preencherCamposAssembly(String instrucao, HashMap tabelaLabels)
	{
		...
		super.shamt = "00000";
		super.funct = Constantes.functNor;
	...
	public void executaEm(UCP ucp) throws Exception 
	{
		...
		rd.setConteudo(ULA.not(ULA.or(rs.getConteudo(), rt.getConteudo())));
	}
}
