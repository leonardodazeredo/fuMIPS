...
public class InstrucaoSrl extends TipoR
{
	public InstrucaoSrl(String instrucao, InterfaceMontadorInstrucao montador)
	{
	...
	protected void preencherCamposAssembly(String instrucao, HashMap tabelaLabels)
	{
		...
		super.rs = "00000";
		super.funct = Constantes.functSrl;
	...
	public void executaEm(UCP ucp) throws NumberFormatException, Exception 
	{
		...
		rd.setConteudo(ULA.shiftR(rt.getConteudo(),Integer.parseInt(shamt)));
	}
}
