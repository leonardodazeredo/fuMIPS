...
public class InstrucaoAnd extends TipoR
{
	public InstrucaoAnd(String instrucao, InterfaceMontadorInstrucao montador)
	{
	...
	protected void preencherCamposAssembly(String instrucao, HashMap tabelaLabels)
	{
		...
		super.shamt = "00000";
		super.funct = Constantes.functAnd;
	...
	public void executaEm(UCP ucp) throws Exception 
	{
		...
		rd.setConteudo(ULA.and(rs.getConteudo(), rt.getConteudo()));
	}
}
