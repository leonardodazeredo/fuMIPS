...
public class InstrucaoAdd extends TipoR
{
	public InstrucaoAdd(String instrucao, InterfaceMontadorInstrucao montador)
	{
	...
	protected void preencherCamposAssembly(String instrucao, HashMap tabelaLabels)
	{
		...
		super.shamt = "00000";
		super.funct = Constantes.functAdd;
	...
	public void executaEm(UCP ucp) throws Exception 
	{
		...
		rd.setConteudo(ULA.soma(rs.getConteudo(), rt.getConteudo()));
	}
}
